...
PROJECT_NAMES=("eureka-server" "feign-consumer" "api-gateway" "oauth-server" "booking-service")
#项目版本号/docker 容器tag,使用项目版本号来做tag，版本号要与项目数组PROJECT_NAMES一一对应
PROJECT_VERSIONS=("1.0.0-SNAPSHOT" "1.0.0-SNAPSHOT" "1.0.0-SNAPSHOT" "1.0.0-SNAPSHOT" "1.0.0-SNAPSHOT")
#docker容器暴露的端口，端口号要与项目数组PROJECT_NAMES一一对应，这里为了简化，docker容器端口与宿主机端口配置成一样的。
EXPOSE_PORTS=("1111" "9002" "5555" "8090" "8080")
